...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  // It also uses GCD, making it a great fit for LPGCDAsyncSocket.
  //
  // As mentioned earlier, enabling logging in LPGCDAsyncSocket is entirely optional.
  // Doing so simply helps give you a deeper understanding of the inner workings of the library (if you care).
  // You can do so at the top of LPGCDAsyncSocket.m,
  ...
  //       2011-12-05 19:54:08:161 [17894:11f03] LPGCDAsyncSocket: Dispatching DNS lookup...
  //       2011-12-05 19:54:08:161 [17894:13303] LPGCDAsyncSocket: Creating IPv4 socket
  //
  // New : 2011-12-05 19:54:08:161 [main] Connecting...
  //       2011-12-05 19:54:08:161 [socket] LPGCDAsyncSocket: Dispatching DNS lookup...
  //       2011-12-05 19:54:08:161 [socket] LPGCDAsyncSocket: Creating IPv4 socket

  DDDispatchQueueLogFormatter *formatter = [[DDDispatchQueueLogFormatter alloc] init];
  [formatter setReplacementString:@"socket" forQueueLabel:LPGCDAsyncSocketQueueName];
  [formatter setReplacementString:@"socket-cf" forQueueLabel:LPGCDAsyncSocketThreadName];
...
- (void)startSocket {
  // Create our LPGCDAsyncSocket instance.
  //
  ...
  asyncSocket = [[LPGCDAsyncSocket alloc] initWithDelegate:self delegateQueue:dispatch_get_main_queue()];

  // Now we tell the ASYNCHRONOUS socket to connect.
  //
  // Recall that LPGCDAsyncSocket is ... asynchronous.
  ...
  //
  // The options passed to the startTLS method are fully documented in the LPGCDAsyncSocket header file.
...
#if USE_CFSTREAM_FOR_TLS
	{
		...
		NSDictionary *options = @{
		    LPGCDAsyncSocketUseCFStreamForTLS : @(YES),
			LPGCDAsyncSocketSSLPeerName : CERT_HOST
		};
...
- (void)socket:(LPGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(UInt16)port {
  ...
  // AsyncSocket adapts to your schedule, not the other way around.
	...
	[asyncSocket readDataToData:[LPGCDAsyncSocket CRLFData] withTimeout:-1.0 tag:0];
